...
function CourseDetail() {
  ...
  const tabs: { key: Tab; label: string }[] = [
    ...
    ...(isAuthenticated ? [{ key: "assistant" as Tab, label: "AI Assistant" }] : []),
  ];
  ...
  return (
    <div className="min-h-screen pt-24 px-6 pb-16">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          <h1
            className="text-3xl font-semibold text-text mb-1"
          ...
          {tabs.map((tab) => (
            <button
              ...
              className={`px-5 py-2.5 text-sm font-medium rounded-t-lg transition-all duration-200 ${
                activeTab === tab.key
                  ? "bg-surface text-text border border-border-light border-b-white -mb-px"
        ...
        {activeTab === "overview" && (
          <div className="bg-surface border border-border-light rounded-2xl p-8 shadow-sm rounded-tl-none">
